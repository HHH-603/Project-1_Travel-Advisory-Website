# Project-1_Travel-Advisory-Website
...
// Given the COVID-19 pandemic, we wanted to build a resource that allows users to view the current (1) travel advisory status of, (2) COVID-19 updates for, and (3) trending news for any major city and country they are considering traveling to.
